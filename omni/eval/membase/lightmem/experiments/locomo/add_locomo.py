...
API_KEYS = [
    'sk-0XGEjliZAkT62SNexypHatr5yUkfpRYXEyUpWgUjPps87C7v',
    "sk-2LmrZbkbGmhyPf8mbHiEcZBj0oMN2NNoX12J8ED0dFbde4Nt",
    "sk-ZWrvxkDx0DTwCBDfrRKZz2VotesCky4je9HTjf3MamjED6Fc"
]
...
# Data Configuration
DATA_PATH = '../data/Locomo/locomo_test.json'
DATASET_TYPE = 'locomo'
...
def extract_locomo_sessions(conversation_dict):
    ...
    for num in sorted(session_nums):
        ...
        for turn in session_data:
            ...
            if 'caption' in turn and turn['caption']:
                content = f"{content} (image description: {turn['caption']})"
            messages.append({
                "role": "user",
                "content": content,
