#!/usr/bin/env bash
# Stage 3: Question Answering & Evaluation for LangMem on LoCoMo.
...
USER_ID="u10"
search_results_path="$ROOT/output/langmem/shared/${USER_ID}/10_0_1.json"
dataset_type="LoCoMo"
qa_model="gpt-5.4-mini"
judge_model="gpt-5.4-mini"
qa_batch_size=4
judge_batch_size=4
api_config_path="examples/evaluate_langmem_on_locomo/api_config.json"
visual_memory_config_path="examples/evaluate_langmem_on_locomo/visual_memory_config.json"
# ========================================================
set -euo pipefail
cd "$(dirname "$0")/../.."
