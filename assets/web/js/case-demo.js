      ...
      thoughts: [
        {
          ...
          relationProof: [
            {
              year: "2026",
              img: "assets/web/case-user-2026-web.webp",
              label: "User now",
              alt: "Current user portrait.",
            },
            {
              year: "2026",
              img: "assets/web/case-daughter-2026-web.webp",
              label: "Daughter now",
              alt: "Current daughter portrait.",
            },
            {
              year: "2016",
              img: "assets/web/case-user-2016-web.webp",
              label: "User 2016",
              alt: "Past user portrait.",
            },
            {
              year: "2016",
              img: "assets/web/case-daughter-2016-web.webp",
              label: "Daughter 2016",
        ...
        },
        {
          ...
          proof: {
            img: "assets/web/case-memory-bank.webp",
        ...
        },
        {
          ...
          proof: {
            img: "assets/web/case-reasoning-match.webp",
        ...
        },
        {
          ...
          proof: {
            img: "assets/web/case-result-birthday.webp",
