...
| Paths                                                | Content                                  |
| ---------------------------------------------------- | ---------------------------------------- |
| `assets/web/institutions*.webp`                      | OPPO and OpenKG.CN identity marks        |
| `assets/web/paper/`                                  | Figures from the MobileMem paper         |
| `assets/web/case-*.webp`, `assets/web/xiaobu-*.webp` | Interactive MobileMem case demonstration |
| `assets/web/memweb/**/*.webp`                        | Curated MobileMem application samples    |
